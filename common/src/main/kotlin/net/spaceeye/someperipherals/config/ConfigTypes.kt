...
class CInt   (it:Int,     description: String="No comment", range: Pair<Int, Int>?       = null, do_show: Boolean=true): BaseConfigDelegate<Int>    (it, range, description, do_show)
class CLong  (it:Long,    description: String="No comment", range: Pair<Long, Long>?     = null, do_show: Boolean=true): BaseConfigDelegate<Long>   (it, range, description, do_show)
class CDouble(it:Double,  description: String="No comment", range: Pair<Double, Double>? = null, do_show: Boolean=true): BaseConfigDelegate<Double> (it, range, description, do_show)
