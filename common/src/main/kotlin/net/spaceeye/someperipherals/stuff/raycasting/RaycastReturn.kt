...
data class RaycastVSShipBlockReturn(val origin: Vector3d, val ship: Ship, val bpos: BlockPos, val res: IBlockRes, val distance_to:Double, val hit_position: Vector3d, val hit_position_ship: Vector3d, val ray: Ray): RaycastReturn()
