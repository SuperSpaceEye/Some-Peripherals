...
data class RaycastVSShipBlockReturn(val ship: Ship, val block: Pair<BlockPos, BlockState>, val distance_to:Double, val hit_position: Vector3d, val hit_position_ship: Vector3d): RaycastReturn()
