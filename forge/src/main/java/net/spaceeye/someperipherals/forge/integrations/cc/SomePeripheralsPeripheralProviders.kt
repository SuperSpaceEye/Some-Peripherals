...
object SomePeripheralsPeripheralProviders {
    @JvmStatic
    fun registerPeripheralProviders() {
        ComputerCraftAPI.registerPeripheralProvider(SomePeripheralsPeripheralProvider())
    }

    class SomePeripheralsPeripheralProvider: IPeripheralProvider {
